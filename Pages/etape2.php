                ...
                <div class="formulaire">
                    ...
                    <script>
                        function loadDoc() {
                            ...
                            var txt = "action=accesPages&"+n;//permet de le convertir enstring car n est une fonction pour changer "+" par " "
                            txt = txt.replaceAll("+", " ");
                            console.log(txt);
                            ...
                            xhr.open("GET", "../PHP/accespages.php");
                            xhr.send("action=accesPages&txt"); 
                        }
                        loadDoc()
                    </script>
